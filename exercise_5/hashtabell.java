...
public class hashtabell {
  public static void main(String[] args) {
    String filepath = "https://www.idi.ntnu.no/emner/idatt2101/hash/navn.txt";
      try (Scanner reader = new Scanner(new URL(filepath).openStream())) {
      ...
      System.out.println("The person \"Svein Kåre Sørestad\" is in the list: " + table.lookup("Svein KÃ¥re SÃ¸restad"));  //UTF issue, replace with "Svein Kåre Sørestad" if you have the file locally
      System.out.println("The person \"Zahid André Kristiansen\" is in the list: " + table.lookup("Zahid AndrÃ© Kristiansen")); //UTF issue, replace with "Zahid André Kristiansen" if you have the file locally
